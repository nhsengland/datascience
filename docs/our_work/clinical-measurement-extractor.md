...
origin: 'NHSD'
tags: ['Social Care', 'Linkage', 'Python', 'Work in Progress']
---
...
<img width="1408" height="1100" alt="Image" src="https://github.com/user-attachments/assets/14d5cc23-2edf-4404-adea-5dfde43b9a52" />
...
Output | Link
---|---
Public CME Repo | [Link](https://github.com/NHSE-NDRS/clinical_measurement_extractor_public)
