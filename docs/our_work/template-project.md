...
If you are submitting via the [automated issue form](https://github.com/NHSEngland/datascience/issues/new?template=project-submission.yml), the navigation in `mkdocs.yml` is updated automatically. If you are creating a project page manually via a PR, make sure you add it into the appropriate navigation sections in the [mkdocs.yml](https://github.com/nhsengland/datascience/blob/main/mkdocs.yml) for website navigation purposes.
