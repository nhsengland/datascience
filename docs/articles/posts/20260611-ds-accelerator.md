---
title: My 12-week journey on the Data Science Accelerator Programme
authors: [Tejal Indulkar]
date: 2026-06-11
categories:
    - Professional Development
links:
    - DSA Applicant Form: https://nhs.sharepoint.com/:w:/r/sites/X24_DataAnalytics/_layouts/15/Doc.aspx?sourcedoc=%7B4AF1173E-6577-4A6A-A900-3A8C1FA319DA%7D&file=Data_Science_Accelerator_Application_Form.docx&action=default&mobileredirect=true
    - DSA Mentor Form: https://nhs.sharepoint.com/:x:/r/sites/X24_DataAnalytics/_layouts/15/Doc.aspx?sourcedoc=%7B25568659-0FBB-47DD-ADD9-C71D1D3856E0%7D&file=Data_Science_Accelerator_Mentor_Skills_Matrix.xlsx&action=default&mobileredirect=true
slug: 20260611-ds-accelerator
description: >
...
To apply as a applicant/mentee or mentor, please complete the relevant application form on the left and send it to [datascience@dhsc.gov.uk](mailto:DataScience@dhsc.gov.uk). The scheme is open to anyone working within DHSC, NHS BSA, and NHS England. 
...
* **_RAP (Reproducible Analytical Pipelines)_** principles
...
As part of the programme, I developed a project focused on the **_NHS Digital Weight Management Programme_**. The aim was to create a tool to support the triaging of patients to the most appropriate level of intervention. For this, I:

* Built a model using **_random forest techniques_**
* Applied **_RAP principles_** to ensure reproducibility
* Used **_GitHub_** for version control — something completely new to me
